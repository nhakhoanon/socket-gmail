...
string createHTML(string str) {
    ...
    string strHTML2 = "</div><div style=\"font-family:'Helvetica Neue', Arial, sans-serif; font-size:14px; line-height:20px; color:#525252;\"><p>Sincerely,</p><p>PROJECT_MMT Team</p></div></td></tr></tbody></table></div></div></blockquote></div>";
